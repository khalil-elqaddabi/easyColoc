<x-app-layout title="New Expense - {{ $category->name }} - {{ $colocation->name }}">
    <div class="flex">
        {{-- Sidebar --}}
        <x-nav></x-nav>
        ...
        <div class="flex-1 mt-20 md:mt-16 md:ml-64 px-4 sm:px-6 lg:px-8 py-8">
            <div class="max-w-2xl mx-auto space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-2xl rounded-3xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div class="px-8 py-10 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20">
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0 mt-1">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                                </svg>
                            </div>
                            <div>
                                <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">New Expense</h1>
                                <p class="text-lg text-gray-600 dark:text-gray-300">
                                    {{ $category->name }} • {{ $colocation->name }}
                                </p>
                            </div>
                        </div>
                    </div>

                    <form method="POST" action="{{ route('colocations.categories.expenses.store', [$colocation, $category]) }}" class="p-8">
                        @csrf
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="date" 
                                           ...
                                           required
                                           class="w-full pl-12 pr-6 py-5 border-2 border-gray-200 dark:border-gray-600 rounded-2xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-4 focus:ring-orange-500 focus:border-orange-500 transition-all shadow-lg hover:shadow-xl @error('start_at') border-red-400 bg-red-50 dark:bg-red-900/20 @enderror">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('amount') }}" 
                                           required
                                           class="w-full pl-16 pr-6 py-5 border-2 border-gray-200 dark:border-gray-600 rounded-2xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-4 focus:ring-orange-500 focus:border-orange-500 transition-all shadow-lg hover:shadow-xl @error('amount') border-red-400 bg-red-50 dark:bg-red-900/20 @enderror"
                                           placeholder="0.00">
                                </div>
                                @error('amount')
                                    <p class="mt-3 text-sm text-red-600 dark:text-red-400 font-medium">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="payer_id" 
                                            required
                                            class="w-full pl-12 pr-6 py-5 border-2 border-gray-200 dark:border-gray-600 rounded-2xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-4 focus:ring-orange-500 focus:border-orange-500 transition-all shadow-lg hover:shadow-xl appearance-none @error('payer_id') border-red-400 bg-red-50 dark:bg-red-900/20 @enderror">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" 
                                           ...
                                           value="{{ old('title') }}"
                                           required
                                           class="w-full pl-12 pr-6 py-5 border-2 border-gray-200 dark:border-gray-600 rounded-2xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-4 focus:ring-orange-500 focus:border-orange-500 transition-all shadow-lg hover:shadow-xl @error('title') border-red-400 bg-red-50 dark:bg-red-900/20 @enderror"
